...
import org.example.camunda.process.solution.dto.TestData;
...
public class ProcessController {
  ...
  public void startProcessInstanceForMortgage(@RequestBody Antragsdaten variables) {
    ...
    LOG.info(
        "Starting process `"
            + ProcessConstants.MORTGAGE_PROCESS_ID
            + "` with variables: "
            + variables);
  ...
  @GetMapping("/testdata")
  public TestData getSomeTestData() {
    return new TestData("PalimPalim");
  }
